...
function setup() 
{
  ...
  stars = createSprite(120,450,50,50);
  stars.addImage(star);
  stars.scale= 0.04
...
function draw() 
{
 ...
 // image(bg_img,0,0,width,height);
  ...
  if(collide(fruit,stars)==true)
  {
    stars.visible = false
    //image(bg_img2,0,0,width,height);
    background(bg_img2);
  }
